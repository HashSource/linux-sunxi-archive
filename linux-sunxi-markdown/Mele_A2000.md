...
### Mele A1000/A2000/A100
  ...
  * The .fex file can be found in sunxi-boards as [mele_a1000.fex][36539]

Everything else is the same as the [ Manual build howto][36540]. 
### Mele A1000G/A2000G/A100G
  * For building u-boot, use the "Mele_A1000G" target.
  * The .fex file can be found in sunxi-boards as [mele_a1000g.fex][36541]
...
It seems that the below targets are completely superfluous, and that the Mele A3700 should just use the A1000G target, but with SATA disabled.
  ...
  * The .fex file can be found in sunxi-boards as [mele_a3700.fex][36542]
...
## Mainline kernel
Use the sun4i-a10-a1000.dts device-tree file for the [mainline kernel][36546]. 
# Tips, Tricks, Caveats
## FEL mode
