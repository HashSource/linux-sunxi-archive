...
(Redirected from [SRAM Controller][48428])
 
# SRAM Controller
## Overview
Static Random Access Memory [SRAM][48431] is used by devices, such as the CPU, for extra fast memory or as cache. 
...
| A3  | `0x00008000 - 0x0000b3ff` | 13 kiB  | EMAC  | Y  | Y  | Y  | Y[[1]][48432] | N  | N   
| A4  | `0x0000b400 - 0x0000bfff` | 3 kiB  | EMAC  | Y  | Y  | ?  | Y[[2]][48433] | N  | N   
| A2  | `0x00044000 - 0x00053fff` | 64 kiB  | Shared with [AR100][48434] OpenRISC core  | N  | N  | N  | N  | Y  | Y   
| VE SRAM  | `0x00004000 - 0x0000ffff` | 64 kiB  |  | N  | N  | N  | N  | ?  | Y   
**B** | B  | `0x00020000 - 0x0002ffff` | 64 kiB  | Secure RAM  | Y  | Y  | N  | Y  | Y  | N   
**C** | C1  | `0x01d00000 - 0x01d7ffff` | 512 kiB {first 62 kiB work on A10, rest is partly read only, wraps around after 0x01d40000}  | CedarV  | Y[[3]][48435] | Y  | Y  | Y  | N  | N   
| C2  | `0x01d80000 - 0x01d9ffff` | 128 kiB {first 6912 B work on A10, rest is partly forced zero}  | CedarA  | Y[[4]][48436] | Y  | ?  | Y  | N  | N   
| C3  | `0x01dc0000 - 0x01dcffff` | 64 kiB {unconfirmed}  | ISP/BIST  | N[[5]][48437] | Y  | Y  | Y  | N  | N   
**D** | D  | `0x00010000 - 0x00010fff` | 4 kiB {unconfirmed}  | USB FIFOs  | Y[[6]][48438] | Y  | Y  | Y  | Y  | N   
...
| CPU L2 Cache  | Not mapped  | 256/128 kiB  |  | N  | Y  | Y  | Y  | Y  | Y   
  1. [↑][48439] For A20 SRAM_A3_A4_MAP set up for emac by default, so you should change it for make it usable
  2. [↑][48440] For A20 SRAM_A3_A4_MAP set up for emac by default, so you should change it for make it usable
  3. [↑][48441] VE must be enabled (AHB gate and VE SCLK)
  4. [↑][48442] ACE must be enabled (AHB gate and ACE SCLK)
  5. [↑][48443] Changing bit SRAM_C3_MAP doesn't allow writing to SRAM_C3( as like others there should be need enable ISP/BIST gate and clock but uncheked)
  6. [↑][48444] Register SRAM_CTL1_CFG needs SRAM_D_MAP set to 0 to allow access
