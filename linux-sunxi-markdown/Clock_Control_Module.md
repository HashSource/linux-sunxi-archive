...
## Contents
  * [1 Clock Control Module][12752]
    * [1.1 Overview][12753]
    * [1.2 Clock domain][12754]
    * [1.3 Clock generation][12755]
      * [1.3.1 PLL][12756]
      * [1.3.2 Bus clock generation][12757]
    * [1.4 Timer Registers][12758]
      * [1.4.1 CCM_PLL1_CFG][12759]
      * [1.4.2 CCM_PLL1_TUN][12760]
      * [1.4.3 CCM_PLL1_TUN2][12761]
      * [1.4.4 CCM_PLL2_CFG][12762]
      * [1.4.5 CCM_PLL2_TUN][12763]
      * [1.4.6 CCM_PLL3_CFG][12764]
      * [1.4.7 CCM_PLL4_CFG][12765]
      * [1.4.8 CCM_PLL5_CFG][12766]
      * [1.4.9 CCM_PLL5_TUN][12767]
      * [1.4.10 CCM_PLL5_TUN2][12768]
      * [1.4.11 CCM_PLL6_CFG][12769]
      * [1.4.12 CCM_PLL6_TUN][12770]
      * [1.4.13 CCM_PLL7_CFG][12771]
      * [1.4.14 CCM_OSC24M_CFG][12772]
      * [1.4.15 CCM_CPU_AXI_AHB_APB0_CFG][12773]
      * [1.4.16 CCM_APB1_CLK_DIV_CFG][12774]
      * [1.4.17 CCM_AXI_CLK_GATE][12775]
      * [1.4.18 CCM_AHB_GATING0][12776]
      * [1.4.19 CCM_AHB_GATING1][12777]
      * [1.4.20 CCM_APB0_GATING][12778]
      * [1.4.21 CCM_APB1_GATING][12779]
      * [1.4.22 CCM_NAND_CLK][12780]
      * [1.4.23 CCM_MMC0_CLK][12781]
      * [1.4.24 CCM_MMC1_CLK][12782]
      * [1.4.25 CCM_MMC2_CLK][12783]
      * [1.4.26 CCM_MMC3_CLK][12784]
      * [1.4.27 CCM_SS_CLK][12785]
      * [1.4.28 CCM_SPI0_CLK][12786]
      * [1.4.29 CCM_SPI1_CLK][12787]
      * [1.4.30 CCM_SPI2_CLK][12788]
      * [1.4.31 CCM_SPI3_CLK][12789]
      * [1.4.32 CCM_IR0_CLK][12790]
      * [1.4.33 CCM_IR1_CLK][12791]
      * [1.4.34 CCM_IIS_CLK][12792]
      * [1.4.35 CCM_A97_CLK][12793]
      * [1.4.36 CCM_SPDIF_CLK][12794]
      * [1.4.37 CCM_KPAD_CLK][12795]
      * [1.4.38 CCM_SATA_CLK][12796]
      * [1.4.39 CCM_USB_CLK][12797]
      * [1.4.40 CCM_GPS_CLK][12798]
      * [1.4.41 CCM_DRAM_CLK][12799]
      * [1.4.42 CCM_DE-BE0_CLK][12800]
      * [1.4.43 CCM_DE-BE1_CLK][12801]
      * [1.4.44 CCM_DE-FE0_CLK][12802]
      * [1.4.45 CCM_DE-FE1_CLK][12803]
      * [1.4.46 CCM_MP_CLK][12804]
      * [1.4.47 CCM_LCD0_CH0_CLK][12805]
      * [1.4.48 CCM_LCD0_CH1_CLK][12806]
      * [1.4.49 CCM_LCD1_CH0_CLK][12807]
      * [1.4.50 CCM_LCD1_CH1_CLK][12808]
      * [1.4.51 CCM_CSI-ISP_CLK][12809]
      * [1.4.52 CCM_TVD_CLK][12810]
      * [1.4.53 CCM_CSI0_CLK][12811]
      * [1.4.54 CCM_CSI1_CLK][12812]
      * [1.4.55 CCM_VE_CLK][12813]
      * [1.4.56 CCM_ADDA_CLK][12814]
      * [1.4.57 CCM_AVS_CLK][12815]
      * [1.4.58 CCM_ACE_CLK][12816]
      * [1.4.59 CCM_LVDS_CLK][12817]
      * [1.4.60 CCM_HDMI_CLK][12818]
      * [1.4.61 CCM_MALI400_CLK][12819]
      * [1.4.62 CCM_MBUS_CTRL][12820]
      * [1.4.63 CCM_MBUS_CH2_CTRL][12821]
    * [1.5 Initial values][12822]
      * [1.5.1 default map][12823]
      * [1.5.2 All to 1 (except main clock)][12824]
      * [1.5.3 All to 0 (except main clock)][12825]
    * [1.6 Code References][12826]

# Clock Control Module
## Overview
Allwinner's A10 has 10 timing or clock sources. 7 [Phase Locking Loop's (PLL's)][12827], a 24MHz main crystal oscillator, an RC based internal on chip based oscillator and a low-power 32kHz crystal oscillator. 
...
AUDIO_CLK  | A/D and D/A devices  | `[24.576 MHz][12828] or [22.5792 MHz][12828]` | The clock for the Audio clock domain is provided by the PLL.   
## Clock generation
All PLL's are fed from the 24 MHz reference clock. 
### PLL
Name  | Input  | Speed range  | Output  | Defines   
---|---|---|---|---  
PLL1  | 24 MHz  | `240 MHz - 2 GHz` |  24 M H z × N × K M × P {\displaystyle {\frac {24\,\mathrm {MHz} \times N\times K}{M\times P}}} ![{\\displaystyle {\\frac {24\\,\\mathrm {MHz} \\times N\\times K}{M\\times P}}}][12829] | ` ``N = {0, 1 ... 31}  
K = {1, 2, 3, 4}  
M = {1, 2, 3, 4}  
P = {1, 2, 4, 8}  
`  
PLL2  | 24 MHz  | `22.5792 MHz or 24.576 MHz` | 22.5792 MHz or 24.576 MHz  |   
PLL3  | 24 MHz  | `27 MHz - 381 MHz` | Integer mode:  3 M H z × M {\displaystyle 3\,\mathrm {MHz} \times M} ![{\\displaystyle 3\\,\\mathrm {MHz} \\times M}][12830]  
  
Fractional mode:  270 M H z ∨ 297 M H z {\displaystyle 270\,\mathrm {MHz} \lor 297\,\mathrm {MHz} } ![{\\displaystyle 270\\,\\mathrm {MHz} \\lor 297\\,\\mathrm {MHz} }][12831] | `M = {9, 10 ... 127}`  
PLL4  | 24 MHz  | `240 MHz - 2 GHz` |  24 M H z × N × K M × P {\displaystyle {\frac {24\,\mathrm {MHz} \times N\times K}{M\times P}}} ![{\\displaystyle {\\frac {24\\,\\mathrm {MHz} \\times N\\times K}{M\\times P}}}][12829] | ` ``N = {0, 1 ... 31}  
K = {1, 2, 3, 4}  
M = {1, 2, 3, 4}  
P = {1, 2, 4, 8}  
`  
PLL5  | 24 MHz  | `240 MHz - 2 GHz` |  24 M H z × N × K M {\displaystyle {\frac {24\,\mathrm {MHz} \times N\times K}{M}}} ![{\\displaystyle {\\frac {24\\,\\mathrm {MHz} \\times N\\times K}{M}}}][12832]  
  
24 M H z × N × K P {\displaystyle {\frac {24\,\mathrm {MHz} \times N\times K}{P}}} ![{\\displaystyle {\\frac {24\\,\\mathrm {MHz} \\times N\\times K}{P}}}][12833] | ` ``N = {0, 1 ... 31}  
K = {1, 2, 3, 4}  
M = {1, 2, 3, 4}  
P = {1, 2, 4, 8}  
`  
PLL6  | 24 MHz  | SATA mode: `100 MHz`  
PLL6 mode: `240 MHz - 2 GHz` | SATA mode:  24 M H z × N × K M × 6 {\displaystyle {\frac {24\,\mathrm {MHz} \times N\times K}{M\times 6}}} ![{\\displaystyle {\\frac {24\\,\\mathrm {MHz} \\times N\\times K}{M\\times 6}}}][12834]  
  
PLL6 mode:  24 M H z × N × K 2 {\displaystyle {\frac {24\,\mathrm {MHz} \times N\times K}{2}}} ![{\\displaystyle {\\frac {24\\,\\mathrm {MHz} \\times N\\times K}{2}}}][12835]  
  
PLL6 * 2 mode:  24 M H z × N × K {\displaystyle 24\,\mathrm {MHz} \times N\times K} ![{\\displaystyle 24\\,\\mathrm {MHz} \\times N\\times K}][12836] | ` ``N = {0, 1 ... 31}  
K = {1, 2, 3, 4}  
M = {1, 2, 3, 4}  
P = {1, 2, 4, 8}  
`  
PLL7  | 24 MHz  | `27 MHz - 381 MHz` | Integer mode:  3 M H z × M {\displaystyle 3\,\mathrm {MHz} \times M} ![{\\displaystyle 3\\,\\mathrm {MHz} \\times M}][12830]  
  
Fractional mode:  270 M H z ∨ 297 M H z {\displaystyle 270\,\mathrm {MHz} \lor 297\,\mathrm {MHz} } ![{\\displaystyle 270\\,\\mathrm {MHz} \\lor 297\\,\\mathrm {MHz} }][12831] | `M = {9, 10 ... 127}`  
### Bus clock generation
Name  | Input  | Output  | Defines   
---|---|---|---  
CPU_CLK  | {32KHZ_CLK, 24MHZ_CLK, PLL1,  P L L 6 6 {\displaystyle {\frac {\mathrm {PLL6} }{6}}} ![{\\displaystyle {\\frac {\\mathrm {PLL6} }{6}}}][12837]}  |  |   
AXI_CLK  | CPU_CLK  |  I n p u t N {\displaystyle {\frac {\mathrm {Input} }{N}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{N}}}][12838] | `N = {1, 2, 3, 4}`  
AHB_CLK  | AXI_CLK  |  I n p u t N {\displaystyle {\frac {\mathrm {Input} }{N}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{N}}}][12838] | `N = {1, 2, 4, 8}`  
APB0_CLK  | AHB_CLK  |  I n p u t N {\displaystyle {\frac {\mathrm {Input} }{N}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{N}}}][12838] | `N = {2, 4, 8}`  
APB1_CLK  | {32KHZ_CLK, 24MHZ_CLK, PLL6}  |  I n p u t M × N {\displaystyle {\frac {\mathrm {Input} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{M\\times N}}}][12839] | ` `
[code]
        M = {1, 2 ... 32}  
...
{NAND_CLK, <unknown>_CLK, SD[0123]_CLK, TS_CLK, SS_CLK, SPI[0123]_CLK, IR[01]_CLK}  | {24MHZ_CLK, PLL5, PLL6}  |  I n p u t M × N {\displaystyle {\frac {\mathrm {Input} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{M\\times N}}}][12839] | ` `
[code]
        M = {1, 2 ... 16}  
...
[/code]  
PATA_CLK  | {PLL5, PLL6}  |  I n p u t M × N {\displaystyle {\frac {\mathrm {Input} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{M\\times N}}}][12839] | ` `
[code]
        M = {1, 2 ... 32}  
...
[/code]  
{IIS_CLK, <unknown>}  | 8 * PLL2  |  I n p u t N {\displaystyle {\frac {\mathrm {Input} }{N}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{N}}}][12838] | `N = {1, 2, 4, 8}`  
KEYPAD_CLK  | {32KHZ_CLK, 24MHZ_CLK}  |  I n p u t M × N {\displaystyle {\frac {\mathrm {Input} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{M\\times N}}}][12839] | ` `
[code]
        M = {1, 2 ... 32}  
...
[/code]  
USB_CLK  | USB_CLK  |  |   
<unknown> | AHB_CLK  |  I n p u t M × N {\displaystyle {\frac {\mathrm {Input} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{M\\times N}}}][12839] | ` `
[code]
        M = {1, 2 ... 32}  
...
[/code]  
{DE-BE[01]_CLK, FE[01]_CLK, MP_CLK}  | {PLL3, PLL5, PLL7}  |  I n p u t M {\displaystyle {\frac {\mathrm {Input} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{M}}}][12840] | `M = {1, 2 ... 16}`  
IEP_CLK  | BE_CLK  |  |   
VE_CLK  | PLL4  |  I n p u t M {\displaystyle {\frac {\mathrm {Input} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{M}}}][12840] | `M = {1, 2 ... 8}`  
LCD_CH0_CLK  | {1 * PLL3, 2 * PLL3, 1 * PLL7, 2 * PLL7}  |  |   
LCD[01]_CH1_CLK2  | {1 * PLL3, 2 * PLL3, 1 * PLL7, 2 * PLL7}  |  I n p u t M {\displaystyle {\frac {\mathrm {Input} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{M}}}][12840] | `M = {1, 2 ... 16}`  
LCD[01]_CH1_CLK1  | LCD[01]_CH1_CLK2  |  I n p u t M {\displaystyle {\frac {\mathrm {Input} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{M}}}][12840] | `M = {1, 2}`  
CSI_ISP_CLK  | {PLL3, PLL4, PLL5, PLL6}  |  I n p u t M {\displaystyle {\frac {\mathrm {Input} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{M}}}][12840] | `M = {1, 2 ... 16}`  
AUDIO_CODEC_CLK  | PLL2  |  I n p u t M {\displaystyle {\frac {\mathrm {Input} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{M}}}][12840] |   
SATA_CLK  | PLL6  |  |   
AVS_CLK  | 24MHZ_CLK  |  |   
HDMI_CLK  | {1 * PLL3, 2 * PLL3, 1 * PLL7, 2 * PLL7}  |  I n p u t M {\displaystyle {\frac {\mathrm {Input} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{M}}}][12840] | `M = {1, 2 ... 16}`  
ACE_CLK  | {PLL4, PLL5, 24MHZ_CLK}  |  I n p u t M {\displaystyle {\frac {\mathrm {Input} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{M}}}][12840] | `M = {1, 2 ... 16}`  
CSI[01]_CLK  | {1 * PLL3, 2 * PLL3, 1 * PLL7, 2 * PLL7}  |  I n p u t M {\displaystyle {\frac {\mathrm {Input} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {Input} }{M}}}][12840] | `M = {1, 2 ... 32}`  
MALI400_CLK  | {PLL3, PLL4, PLL5, PLL7}  |  381 M H z ≥ I n p u t M {\displaystyle 381\,\mathrm {MHz} \geq {\frac {\mathrm {Input} }{M}}} ![{\\displaystyle 381\\,\\mathrm {MHz} \\geq {\\frac {\\mathrm {Input} }{M}}}][12841] | `M = {1, 2 ... 16}`  
## Timer Registers
...
[/code]
|  24 M H z × N × K M × P {\displaystyle {\frac {24\,\mathrm {MHz} \times N\times K}{M\times P}}} ![{\\displaystyle {\\frac {24\\,\\mathrm {MHz} \\times N\\times K}{M\\times P}}}][12829]  
...
[/code]
| PLL2 is used for Audio. Output formula:  24 M H z × N C C M _ P L L _ V C O _ B I A S × C C M _ P L L _ B I A S {\displaystyle {\frac {24\,\mathrm {MHz} \times N}{\mathrm {CCM\\_PLL\\_VCO\\_BIAS} \times \mathrm {CCM\\_PLL\\_BIAS} }}} ![{\\displaystyle {\\frac {24\\,\\mathrm {MHz} \\times N}{\\mathrm {CCM\\_PLL\\_VCO\\_BIAS} \\times \\mathrm {CCM\\_PLL\\_BIAS} }}}][12842]  
...
[code] 
    ...
    ![{\\displaystyle {\\frac {\(2\\times 24\\,\\mathrm {MHz} \)\\times N}{\\mathrm {CCM\\_PLL\\_VCO\\_BIAS} \\times \\mathrm {CCM\\_PLL\\_BIAS} \\times 2}}}][12843](Not 50% duty cycle)  
...
[code] 
    ...
    ![{\\displaystyle {\\frac {\(2\\times 24\\,\\mathrm {MHz} \)\\times N}{\\mathrm {CCM\\_PLL\\_VCO\\_BIAS} \\times \\mathrm {CCM\\_PLL\\_BIAS} \\times 4}}}][12844](8 x /4 50% duty cycle)  
...
[code] 
    ...
    ![{\\displaystyle {\\frac {\(2\\times 24\\,\\mathrm {MHz} \)\\times N}{\\mathrm {CCM\\_PLL\\_VCO\\_BIAS} \\times \\mathrm {CCM\\_PLL\\_BIAS} \\times 2}}}][12843](8 x /2 50% duty cycle)  
...
[code] 
    ...
    ![{\\displaystyle {\\frac {\(2\\times 24\\,\\mathrm {MHz} \)\\times N}{\\mathrm {CCM\\_PLL\\_VCO\\_BIAS} \\times \\mathrm {CCM\\_PLL\\_BIAS} }}}][12845](Not 50% duty cycle)
...
[code] 
    ...
    ![{\\displaystyle 3\\,\\mathrm {MHz} \\times M}][12830]  
    ...
    ![{\\displaystyle 270\\,\\mathrm {MHz} \\lor 297\\,\\mathrm {MHz} }][12831] (see bit 14)
...
[code] 
    ...
    ![{\\displaystyle {\\frac {24\\,\\mathrm {MHz} \\times N\\times K}{M\\times P}}}][12829]  
...
[code] 
    ...
    ![{\\displaystyle {\\frac {24\\,\\mathrm {MHz} \\times N\\times K}{M}}}][12832]  
    ...
    ![{\\displaystyle {\\frac {24\\,\\mathrm {MHz} \\times N\\times K}{P}}}][12833]  
...
[code] 
    ...
    ![{\\displaystyle {\\frac {24\\,\\mathrm {MHz} \\times N\\times K}{M\\times 6}}}][12834]  
    ...
    ![{\\displaystyle {\\frac {24\\,\\mathrm {MHz} \\times N\\times K}{2}}}][12835]  
...
Some special modules (twi, uart, ps2, can, scr) using the APB_CLK use this clock as they need a special clock rate, even if APB_CLK is changed.  C C M _ A P B 1 _ C L K _ S R C M × N {\displaystyle {\frac {\mathrm {CCM\\_APB1\\_CLK\\_SRC} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_APB1\\_CLK\\_SRC} }{M\\times N}}}][12846]  
...
C C M _ N A N D _ C L K _ S R C M × N {\displaystyle {\frac {\mathrm {CCM\\_NAND\\_CLK\\_SRC} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_NAND\\_CLK\\_SRC} }{M\\times N}}}][12847]  
### CCM_MMC0_CLK
Default value: 0x00000000  
Offset: 0x0088 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ M M C 0 _ C L K _ S R C M × N {\displaystyle {\frac {\mathrm {CCM\\_MMC0\\_CLK\\_SRC} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_MMC0\\_CLK\\_SRC} }{M\\times N}}}][12848]  
### CCM_MMC1_CLK
Default value: 0x00000000  
Offset: 0x008c 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ M M C 1 _ C L K _ S R C M × N {\displaystyle {\frac {\mathrm {CCM\\_MMC1\\_CLK\\_SRC} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_MMC1\\_CLK\\_SRC} }{M\\times N}}}][12849]  
### CCM_MMC2_CLK
Default value: 0x00000000  
Offset: 0x0090 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ M M C 2 _ C L K _ S R C M × N {\displaystyle {\frac {\mathrm {CCM\\_MMC2\\_CLK\\_SRC} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_MMC2\\_CLK\\_SRC} }{M\\times N}}}][12850]  
### CCM_MMC3_CLK
Default value: 0x00000000  
Offset: 0x0094 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ M M C 3 _ C L K _ S R C M × N {\displaystyle {\frac {\mathrm {CCM\\_MMC3\\_CLK\\_SRC} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_MMC3\\_CLK\\_SRC} }{M\\times N}}}][12851]  
### CCM_SS_CLK
Default value: 0x00000000  
Offset: 0x009c 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ S S _ C L K _ S R C M × N {\displaystyle {\frac {\mathrm {CCM\\_SS\\_CLK\\_SRC} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_SS\\_CLK\\_SRC} }{M\\times N}}}][12852]  
...
C C M _ S P I 0 _ C L K _ S R C M × N {\displaystyle {\frac {\mathrm {CCM\\_SPI0\\_CLK\\_SRC} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_SPI0\\_CLK\\_SRC} }{M\\times N}}}][12853]  
### CCM_SPI1_CLK
Default value: 0x00000000  
Offset: 0x00a4 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ S P I 1 _ C L K _ S R C M × N {\displaystyle {\frac {\mathrm {CCM\\_SPI1\\_CLK\\_SRC} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_SPI1\\_CLK\\_SRC} }{M\\times N}}}][12854]  
### CCM_SPI2_CLK
Default value: 0x00000000  
Offset: 0x00a8 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ S P I 2 _ C L K _ S R C M × N {\displaystyle {\frac {\mathrm {CCM\\_SPI2\\_CLK\\_SRC} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_SPI2\\_CLK\\_SRC} }{M\\times N}}}][12855]  
### CCM_SPI3_CLK
Default value: 0x00000000  
Offset: 0x00d4 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ S P I 3 _ C L K _ S R C M × N {\displaystyle {\frac {\mathrm {CCM\\_SPI3\\_CLK\\_SRC} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_SPI3\\_CLK\\_SRC} }{M\\times N}}}][12856]  
### CCM_IR0_CLK
Default value: 0x00000000  
Offset: 0x00b0 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ I R 0 _ C L K _ S R C M × N {\displaystyle {\frac {\mathrm {CCM\\_IR0\\_CLK\\_SRC} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_IR0\\_CLK\\_SRC} }{M\\times N}}}][12857]  
### CCM_IR1_CLK
Default value: 0x00000000  
Offset: 0x00b4 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ I R 1 _ C L K _ S R C M × N {\displaystyle {\frac {\mathrm {CCM\\_IR1\\_CLK\\_SRC} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_IR1\\_CLK\\_SRC} }{M\\times N}}}][12858]  
### CCM_IIS_CLK
Default value: 0x00000000  
Offset: 0x00b8 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
8 × P L L 2 M × N {\displaystyle {\frac {8\times \mathrm {PLL2} }{M\times N}}} ![{\\displaystyle {\\frac {8\\times \\mathrm {PLL2} }{M\\times N}}}][12859]  
### CCM_A97_CLK
...
8 × P L L 2 N {\displaystyle {\frac {8\times \mathrm {PLL2} }{N}}} ![{\\displaystyle {\\frac {8\\times \\mathrm {PLL2} }{N}}}][12860]  
...
C C M _ K P A D _ C L K _ S R C M × N {\displaystyle {\frac {\mathrm {CCM\\_KPAD\\_CLK\\_SRC} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_KPAD\\_CLK\\_SRC} }{M\\times N}}}][12861]  
...
C C M _ D E − B E 0 _ C L K _ S R C M {\displaystyle {\frac {\mathrm {CCM\\_DE-BE0\\_CLK\\_SRC} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_DE-BE0\\_CLK\\_SRC} }{M}}}][12862]  
...
C C M _ D E − B E 1 _ C L K _ S R C M {\displaystyle {\frac {\mathrm {CCM\\_DE-BE1\\_CLK\\_SRC} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_DE-BE1\\_CLK\\_SRC} }{M}}}][12863]  
### CCM_DE-FE0_CLK
Default value: 0x00000000  
Offset: 0x010c 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ D E − F E 0 _ C L K _ S R C M {\displaystyle {\frac {\mathrm {CCM\\_DE-FE0\\_CLK\\_SRC} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_DE-FE0\\_CLK\\_SRC} }{M}}}][12864]  
### CCM_DE-FE1_CLK
Default value: 0x00000000  
Offset: 0x0110 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ D E − F E 1 _ C L K _ S R C M {\displaystyle {\frac {\mathrm {CCM\\_DE-FE1\\_CLK\\_SRC} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_DE-FE1\\_CLK\\_SRC} }{M}}}][12865]  
### CCM_MP_CLK
Default value: 0x00000000  
Offset: 0x0114 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ M P _ C L K _ S R C M {\displaystyle {\frac {\mathrm {CCM\\_MP\\_CLK\\_SRC} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_MP\\_CLK\\_SRC} }{M}}}][12866]  
...
C C M _ L C D 0 _ C H 0 _ C L K _ S R C {\displaystyle \mathrm {CCM\\_LCD0\\_CH0\\_CLK\\_SRC} } ![{\\displaystyle \\mathrm {CCM\\_LCD0\\_CH0\\_CLK\\_SRC} }][12867]  
### CCM_LCD0_CH1_CLK
Default value: 0x00000000  
Offset: 0x012c 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ L C D 0 _ C H 1 _ C L K _ S R C 1 M {\displaystyle {\frac {\mathrm {CCM\\_LCD0\\_CH1\\_CLK\\_SRC1} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_LCD0\\_CH1\\_CLK\\_SRC1} }{M}}}][12868]  
### CCM_LCD1_CH0_CLK
Default value: 0x00000000  
Offset: 0x011c 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ L C D 1 _ C H 0 _ C L K _ S R C {\displaystyle \mathrm {CCM\\_LCD1\\_CH0\\_CLK\\_SRC} } ![{\\displaystyle \\mathrm {CCM\\_LCD1\\_CH0\\_CLK\\_SRC} }][12869]  
...
C C M _ L C D 1 _ C H 1 _ C L K _ S R C 1 M {\displaystyle {\frac {\mathrm {CCM\\_LCD1\\_CH1\\_CLK\\_SRC1} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_LCD1\\_CH1\\_CLK\\_SRC1} }{M}}}][12870]  
...
C C M _ C S I − I S P _ C L K _ S R C M {\displaystyle {\frac {\mathrm {CCM\\_CSI-ISP\\_CLK\\_SRC} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_CSI-ISP\\_CLK\\_SRC} }{M}}}][12871]  
### CCM_TVD_CLK
Default value: 0x00000000  
Offset: 0x0128 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ T V D _ C L K _ S R C M {\displaystyle {\frac {\mathrm {CCM\\_TVD\\_CLK\\_SRC} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_TVD\\_CLK\\_SRC} }{M}}}][12872]  
### CCM_CSI0_CLK
Default value: 0x00000000  
Offset: 0x0134 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ C S I 0 _ C L K _ S R C M {\displaystyle {\frac {\mathrm {CCM\\_CSI0\\_CLK\\_SRC} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_CSI0\\_CLK\\_SRC} }{M}}}][12873]  
### CCM_CSI1_CLK
Default value: 0x00000000  
Offset: 0x0138 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
[/code]
| CSI special clock gating:  
C C M _ C S I 1 _ C L K _ S R C 1 M {\displaystyle {\frac {\mathrm {CCM\\_CSI1\\_CLK\\_SRC1} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_CSI1\\_CLK\\_SRC1} }{M}}}][12874]  
### CCM_VE_CLK
Default value: 0x00000000  
Offset: 0x013c 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
[/code]
| CSI special clock gating:  
P L L 4 M {\displaystyle {\frac {\mathrm {PLL4} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {PLL4} }{M}}}][12875]  
...
P L L 2 {\displaystyle \mathrm {PLL2} } ![{\\displaystyle \\mathrm {PLL2} }][12876]  
### CCM_AVS_CLK
Default value: 0x00000000  
Offset: 0x0144 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
O S C 24 M {\displaystyle \mathrm {OSC24M} } ![{\\displaystyle \\mathrm {OSC24M} }][12877]  
...
C C M _ A C E _ C L K _ S R C M {\displaystyle {\frac {\mathrm {CCM\\_ACE\\_CLK\\_SRC} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_ACE\\_CLK\\_SRC} }{M}}}][12878]  
...
C C M _ H D M I _ C L K _ S R C 1 M {\displaystyle {\frac {\mathrm {CCM\\_HDMI\\_CLK\\_SRC1} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_HDMI\\_CLK\\_SRC1} }{M}}}][12879]  
...
C C M _ M A L I 400 _ C L K _ S R C M {\displaystyle {\frac {\mathrm {CCM\\_MALI400\\_CLK\\_SRC} }{M}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_MALI400\\_CLK\\_SRC} }{M}}}][12880]  
### CCM_MBUS_CTRL
Default value: 0x00000000  
Offset: 0x015c 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
...
C C M _ M B U S _ C L K _ S R C M × N {\displaystyle {\frac {\mathrm {CCM\\_MBUS\\_CLK\\_SRC} }{M\times N}}} ![{\\displaystyle {\\frac {\\mathrm {CCM\\_MBUS\\_CLK\\_SRC} }{M\\times N}}}][12881]  
### CCM_MBUS_CH2_CTRL
Default value: 0x00000000  
Offset: 0x0160 
Name  | Bit  | Read/Write  | Default (Hex)  | Values  | Description   
