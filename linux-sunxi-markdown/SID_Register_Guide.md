...
[ROTPK_HASH][48270] | 0x64 | 256 bit | SHA256 hash of the "Root of Trust" public key   
...
[LCJS][48271] | 0xf4 | 32 bit | Flags (secure boot mode, ...)   
...
---|---|---|---  
CHIPID | 0x00 | 128 bit | Chip-ID, also known as SID   
[BROM_CONFIG][48272] | 0x10 | 32 bit | _unknown_ , "16 bits config, 16 bits try"   
...
[LCJS][48271] | 0x48 | 32 bit | Flags (secure boot mode, ...)   
ATTR | 0x4c | 32 bit | _unknown_  
HUK | 0x50 | 256 bit | Hardware Unique Key, later split in IN(192), IDENTIFI(32), ID(32)   
VENDOR_ID | 0x5C | 32 bit | Read by SBROM to check [TOC0][48279] key item, overlaps HUK   
[ROTPK_HASH][48270] | 0x70 | 256 bit | SHA256 hash of the "Root of Trust" public key   
